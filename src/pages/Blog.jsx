...
const Blog = () => {
  return (
    <>
      <Helmet>
        <title>مدونة هبه ناتشورالز | كتابات الدكتوره هبه مهاجر</title>
        <meta
          name="description"
          content="مقالات علميه وتجارب حقيقيه من الدكتوره هبه مهاجر عن العنايه الطبيعيه بالشعر الأفريقي والمجعد، التركيبات الأيورفيديه، وأسرار النتائج الحقيقيه."
        />
      </Helmet>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="text-xl opacity-90">
              كل أسبوع مقال جديد من الدكتوره هبه مهاجر
            </p>
          </motion.div>
